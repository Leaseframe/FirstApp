...
fun ProfilScreen(
    ...
    if (afficherDialogue) {
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    onClick = { viewModel.confirmerDeconnexion() }
                ) {
                    Text("Se déconnecter")
                }
            },
            dismissButton = {
                TextButton(
                    onClick = { viewModel.annulerDeconnexion() }
                ) {
                    Text("Annuler")
                }
            }
        ...
        Row(modifier = Modifier.padding(16.dp)) {
            ...
            Column {
                ...
                LigneIcone(
                    ...
                    texte = utilisateur.email
                )

                LigneIcone(
                    icon = Icons.Filled.Phone,
                    texte = utilisateur.telephone
                )

                LigneIcone(
                    icon = Icons.Filled.LocationOn,
                    texte = utilisateur.ville
                )
...
@Composable
private fun CarteSecurite(navController: NavHostController) {
    Card(modifier = Modifier.fillMaxWidth()) {
        Column {
            Row(
                modifier = Modifier
            ...
            Row(
                ...
                IconButton(
                    onClick = {
                        navController.navigate("new_delivery")
                    }
                ) {
                    Icon(
                        Icons.Filled.Lock,
